...
- [Preserve every factual clause](#preserve-every-factual-clause)
- [Explicit skill scope is functional](#explicit-skill-scope-is-functional)
- [A cookbook keeps action and verification](#a-cookbook-keeps-action-and-verification)
- [Preserve ownership and timing](#preserve-ownership-and-timing)
- [Event JSDoc preserves boundary timing](#event-jsdoc-preserves-boundary-timing)
- [Orient complicated code without narrating it](#orient-complicated-code-without-narrating-it)
...
- [Do not trim for word count alone](#do-not-trim-for-word-count-alone)
- [Model-visible text follows ownership](#model-visible-text-follows-ownership)
- [Generated summaries must stand alone](#generated-summaries-must-stand-alone)
- [Limitations are contracts, not debt inventories](#limitations-are-contracts-not-debt-inventories)
