...
| Source and exact range | Disposition | Portable destination or exclusion reason |
|---|---|---|
| [`standard/agent.cordis.yml`, lines 22-33 and 100-124](https://github.com/deepseek-ai/deepseek-harness/blob/47f943859bef60e4160492346772ded9b24f765a/apps/cli/config/agent-presets/standard/agent.cordis.yml#L22-L124) | Retained and adapted | Plan-mode prompt becomes `plan-code-changes` and user defaults. Identity, registry, tool, and runtime composition are platform internals. |
