...
- `registry/` holds management metadata, not installable skills:
  ...
  - `registry/ledger.yaml` — the generated ledger; never hand-edit.
...
`registry/ledger.yaml` is GENERATED by `skills/manage-skills/scripts/sync-registry.mjs`. Never hand-edit it.
...
- The ledger has sections for global third-party, per-project third-party, scan issues, and forks.
