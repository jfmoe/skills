# Chapter 10 - Async Rust Patterns

Production patterns for async Rust with Tokio, including tasks, channels, streams, error handling, cancellation, and resource management.
...
| `.await` | Suspend until a future can make progress |
